package com.mavacore369.domain.com.class_example.doctor;
...
public class AppoinmentMain {
	...
	public static void main(String[] args) {
		...
		Doctor doctor = new Doctor(1102, "Chansantoki", "yes");
		Doctor doctor2 = new Doctor(1103, "Ziet Licht In de Tunnel", "no");
		PersonalSecretary personalSecretary = new PersonalSecretary(1, "Pakkito");
		Patient patient = new Patient(1, "Melasia");
		Patient patient2 = new Patient(2, "Chaeyyene");
