...
/*
*IOException is a checked exception in Java that is thrown when an input/output operation fails or is interrupted.
* An I/O operation can fail for many reasons, such as a file not existing, a network connection being lost, or a disk being full.
*In Java, IOException is a subclass of the Exception class, which means it is a checked exception that must be caught or declared in the method signature
*
* */
